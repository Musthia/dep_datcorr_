...
class Frame(tk.Frame):
    ...
    def campos_Catastro_database(self):
        ...
        self.entry_ingreso.config(width= 40, font = ("Arial", 10, "bold"))
    ...
    def mostrar_resultados(self, rows):
        ...
        ventana_resultados.geometry("1320x600")
        ...
        # Treeview
        treeview_resultados = ttk.Treeview(frame_superior, yscrollcommand=scrollbar.set)
        treeview_resultados.pack(fill="both", expand=True)
        scrollbar.config(command=treeview_resultados.yview)
    
        treeview_resultados.bind("<<TreeviewSelect>>", self.on_treeview_select)

        # Configurar columnas (tu código original aquí)
        treeview_resultados["columns"] = ("ID", "DENOMINACION", "DEPARTAMENTO", "EXPEDIENTE", "ESTADO", "CARATULA", "INGRESO",
                                          "EGRESO", "ULTIMO MOVIMIENTO", "N_LOTE", "DOCUMENTO", "AÑO", "FICHA", "ZONA", "CAJA", "REGISTRO")
        treeview_resultados.column("#0", width=0, stretch=tk.NO)
        treeview_resultados.column("ID", anchor=tk.CENTER, width=10)
        treeview_resultados.column("DENOMINACION", anchor=tk.CENTER, width=200)
        treeview_resultados.column("DEPARTAMENTO", anchor=tk.CENTER, width=25)
        treeview_resultados.column("EXPEDIENTE", anchor=tk.CENTER, width=150)
        treeview_resultados.column("ESTADO", anchor=tk.CENTER, width=80)
        treeview_resultados.column("CARATULA", anchor=tk.CENTER, width=50)
        treeview_resultados.column("INGRESO", anchor=tk.CENTER, width=35)
        treeview_resultados.column("EGRESO", anchor=tk.CENTER, width=100)
        treeview_resultados.column("ULTIMO MOVIMIENTO", anchor=tk.CENTER, width=50)
        treeview_resultados.column("N_LOTE", anchor=tk.CENTER, width=80)
        treeview_resultados.column("DOCUMENTO", anchor=tk.CENTER, width=80)
        treeview_resultados.column("AÑO", anchor=tk.CENTER, width=35)
        treeview_resultados.column("FICHA", anchor=tk.CENTER, width=35)
        treeview_resultados.column("ZONA", anchor=tk.CENTER, width=35)
        treeview_resultados.column("CAJA", anchor=tk.CENTER, width=120)
        treeview_resultados.column("REGISTRO", anchor=tk.CENTER, width=120)
        ...
        treeview_resultados.heading("DEPARTAMENTO", text="DEPARTAENTO", anchor=tk.CENTER)
        treeview_resultados.heading("EXPEDIENTE", text="EXPEDIENTE", anchor=tk.CENTER)
        treeview_resultados.heading("ESTADO", text="ESTADO", anchor=tk.CENTER)
        treeview_resultados.heading("CARATULA", text="CARATULA", anchor=tk.CENTER)
        treeview_resultados.heading("INGRESO", text="INGRESO", anchor=tk.CENTER)
        treeview_resultados.heading("EGRESO", text="EGRESO", anchor=tk.CENTER)
        treeview_resultados.heading("ULTIMO MOVIMIENTO", text="ULTIMO MOVIMIENTO", anchor=tk.CENTER)
        treeview_resultados.heading("N_LOTE", text="N° DE LOTE", anchor=tk.CENTER)
        treeview_resultados.heading("DOCUMENTO", text="DOCUMENTO", anchor=tk.CENTER)
        treeview_resultados.heading("AÑO", text="AÑO", anchor=tk.CENTER)
        treeview_resultados.heading("FICHA", text="FICHA", anchor=tk.CENTER)
        treeview_resultados.heading("ZONA", text="ZONA", anchor=tk.CENTER)
