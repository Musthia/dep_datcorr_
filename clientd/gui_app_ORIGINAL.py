...
def barra_menu(root,  nivel_seguridad):
    ...
    menu_inicio.add_command(label="Crear Base de Datos: DEPOSITO", command = crear_tabla)
...
class Frame(tk.Frame):
    ...
    def campos_Catastro_database(self):
        ...
        #Botones recupero
        self.boton_recupero = tk.Button(self, text = "RECUPERAR DATOS", command = self.desabilitar_campos)
        self.boton_recupero.config(width=14, font=("Arial",10, "bold"), fg = "#000000", bg="#40A000",cursor = "hand2", activebackground= "#FFFFFF")
        self.boton_recupero.grid(row=1, column=2)
