...
#
        ...
        title_label = tk.Label(self, text="DATCORR: DEPOSITO ", font=font_title, fg="#5c5c5c")
#
...
class InicioSesionVentana(tk.Tk):
    ...
    def barra_menu(self):
        ...
        barra_menu.add_cascade(label="Tabla Usuarios", menu=menu_usuario)
